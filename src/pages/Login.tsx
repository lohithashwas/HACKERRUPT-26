...
import { ShieldCheck, ArrowRight, Lock, Users, Siren, LockKeyhole, HandHeart } from "lucide-react"
        ...
        switch (role) {
            case 'user':
                return {
                    ...
                    icon: Users,
                    desc: 'Secure access for public safety services',
            ...
            case 'police':
                return {
                    ...
                    icon: ShieldCheck,
                    desc: 'Law enforcement authorized access only',
            ...
            case 'emergency':
                return {
                    ...
                    icon: Siren,
                    desc: 'Rapid response coordination unit',
            ...
            case 'volunteer':
                return {
                    title: 'P-R Volunteer',
                    icon: HandHeart,
                    desc: 'Community support network access',
            ...
            <div className="w-full max-w-6xl z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p className="text-gray-400 text-xl max-w-lg leading-relaxed">
                        The centralized command center for the <strong>Proactive Safety Wearable</strong> ecosystem. Rapid response, redefined.
                    </p>
                    ...
                    <div className="flex items-center gap-8 pt-4">
                        ...
                        <div className="text-gray-400">
                            ...
                            <span className="text-sm">Real-time Coverage</span>
                        </div>
                    </div>
                </motion.div>
                                    ...
                                    <form onSubmit={handleLogin} className="space-y-6">
                                        ...
                                        <div className="flex items-center justify-between text-sm pt-2">
                                            <label className="flex items-center space-x-2.5 cursor-pointer group">
                                                ...
                                                <span className="text-gray-500 group-hover:text-gray-300 transition-colors font-medium">Remember me</span>
                                            </label>
